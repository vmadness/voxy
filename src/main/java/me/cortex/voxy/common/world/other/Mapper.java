    ...
    public static final class StateEntry {
        ...
        public static StateEntry deserialize(int id, byte[] data, boolean[] forceResave) {
            try {
                ...
                if (!compound.contains("id", CompoundTag.TAG_INT) || compound.getInt("id") != id) {
                    throw new IllegalStateException("Encoded id != expected id");
                }
                if (!compound.contains("block_state", CompoundTag.TAG_COMPOUND)) {
    ...
    public static final class BiomeEntry {
        ...
        public static BiomeEntry deserialize(int id, byte[] data) {
            try {
                ...
                String biome = compound.contains("biome_id", CompoundTag.TAG_STRING) ? compound.getString("biome_id") : null;
